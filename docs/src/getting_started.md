...
Tonalli's NPU path targets **AMD Ryzen AI chips with an XDNA 2 NPU** (Ryzen AI 300-series /
Strix / Krackan / Kraken). Ryzen AI 7000/8000/200-series (XDNA 1) are **not** supported by
the FastFlowLM backend.
